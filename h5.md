...
- The database in question:
   - <img width="419" alt="Screenshot 2025-02-19 at 22 55 37" src="https://github.com/user-attachments/assets/428086e4-c7ac-4460-8da4-4fd0d0ad71b0" />
...
- I've been using one for a few years now, but the only problem is, it's stored in the cloud, sitting on one of the worlds biggest tech-company's servers (i think, they might be using third-parties for all i know 😂). Now I can migrate them away from there, and host them myself. Might fuck around and download them on a USB aswell 🤷‍♂️
