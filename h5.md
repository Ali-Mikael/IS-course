...
# PGP (C)
Time to set up encryption key-pairs and start sending enrypted messages. Let's dive righ in!
...
### Final thoughts
- This was the perfect step to take after configuring the SSH public-key authentication, as it expanded on the pub-key / private-key consept and how they are implemented in practise. Also got some needed hands-on practise on configuring and setting up this kind of stuff!
